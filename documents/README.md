...
*  Middleware support. All [alice](https://github.com/justinas/alice) compatible Middleware works out of the box
...
* [gorm](https://github.com/jinzhu/gorm) , this documntation is based on
